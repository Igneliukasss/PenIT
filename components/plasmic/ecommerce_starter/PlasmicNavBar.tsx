...
import * as sty from "./PlasmicNavBar.module.css"; // plasmic-import: YOpe0hL5L4N3/css
...
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: RKcGxI9H8E8h/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: zJRyGBfNc8ZW/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: IS2v2jNhf5Ec/icon
    ...
    >
      ...
      >
        <Button link2={"/" as const} slot={"Home"}>
          <Icon24Icon
            className={classNames(defaultcss.all, sty.svg__bFy4V)}
            role={"img"}
          />
        </Button>

        <div className={classNames(defaultcss.all, sty.freeBox__i9P0)} />

        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__euemu, {
            [sty.freeBox__searchOpen__euemuM2P3O]: hasVariant(
              variants,
              "searchOpen",
              "searchOpen"
            )
        ...
        >
          {(hasVariant(variants, "searchOpen", "searchOpen") ? false : true) ? (
            <Button
              className={classNames("__wab_instance", {
                [sty.button__searchOpen__lFpjgM2P3O]: hasVariant(
                  variants,
                  "searchOpen",
                  "searchOpen"
                )
            ...
            >
              <Icon2Icon
                className={classNames(defaultcss.all, sty.svg__xP5VF)}
                role={"img"}
              />
            </Button>
          ) : null}
          ...
          <Button icons={"only" as const} slot={"Menu"}>
            <Icon3Icon
              className={classNames(defaultcss.all, sty.svg__e9A7B)}
              role={"img"}
            />
          </Button>

          <div className={classNames(defaultcss.all, sty.freeBox__vterE)}>
            <Button
            ...
            >
              <Icon4Icon
                className={classNames(defaultcss.all, sty.svg__ro2HT)}
                role={"img"}
              />
            </Button>
          </div>
