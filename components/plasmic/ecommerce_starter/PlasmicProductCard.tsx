...
import * as sty from "./PlasmicProductCard.module.css"; // plasmic-import: 72J1CxYHdAMS/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: pAQYl0DgHHRE/icon
import Icon8Icon from "./icons/PlasmicIcon__Icon8"; // plasmic-import: ZdyWeopgtiGf/icon
import Icon7Icon from "./icons/PlasmicIcon__Icon7"; // plasmic-import: NpoSA6-3ibz8/icon
import Icon6Icon from "./icons/PlasmicIcon__Icon6"; // plasmic-import: 2w7D3N25xBql/icon
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__e3P5Z)}
              src={
        ...
        {(
          ...
          <div
            className={classNames(defaultcss.all, sty.freeBox__wdWyt, {
              [sty.freeBox__small__wdWyteivE4]: hasVariant(
                variants,
                "small",
                "small"
              )
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox___8WVuf, {
            [sty.freeBox__small___8WVufeivE4]: hasVariant(
              variants,
              "small",
              "small"
            )
        ...
        >
          <div className={classNames(defaultcss.all, sty.freeBox__b0Fwv)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
            ...
            <Button
              ...
              children3={
                <Icon8Icon
                  className={classNames(defaultcss.all, sty.svg__mpSrE)}
                  role={"img"}
                />
              }
              children32={
                <Icon8Icon
                  className={classNames(defaultcss.all, sty.svg__z61Jl)}
                  role={"img"}
                />
              }
              children322={
                <Icon7Icon
                  className={classNames(defaultcss.all, sty.svg__nqyNm)}
                  role={"img"}
                />
              }
              children3222={
                <Icon6Icon
                  className={classNames(defaultcss.all, sty.svg__vWlIm)}
                  role={"img"}
                />
              }
              icons={"five" as const}
            ...
            >
              <Icon8Icon
                className={classNames(defaultcss.all, sty.svg__rCj3Z)}
                role={"img"}
              />
            </Button>
          </div>
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__kiGJ)}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
