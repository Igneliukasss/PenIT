...
import * as sty from "./PlasmicCopyrightSocialLanguage.module.css"; // plasmic-import: 22is3qBcO0Q5/css

import Icon27Icon from "./icons/PlasmicIcon__Icon27"; // plasmic-import: uyPReBgfAN3S/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: pAQYl0DgHHRE/icon
import Icon28Icon from "./icons/PlasmicIcon__Icon28"; // plasmic-import: kitJr6gZ2hEG/icon
import Icon29Icon from "./icons/PlasmicIcon__Icon29"; // plasmic-import: 5xuoyv5Q_TKS/icon
import Icon15Icon from "./icons/PlasmicIcon__Icon15"; // plasmic-import: fqDzYTF4msww/icon
          ...
          defaultContents: (
            <React.Fragment>
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__xQNsa)}
              >
                <div
                ...
                <div className={classNames(defaultcss.all, sty.freeBox__qBzhb)}>
                  <Button
                    icons={"only" as const}
                    link2={"http://twitter.com" as const}
                  >
                    <Icon27Icon
                      className={classNames(defaultcss.all, sty.svg___59Hz)}
                      role={"img"}
                    />
                  </Button>

                  <Button
                    className={classNames("__wab_instance", sty.button__bt10)}
                    icons={"only" as const}
                    link2={"http://youtube.com" as const}
                  >
                    <Icon28Icon
                      className={classNames(defaultcss.all, sty.svg__uYfsE)}
                      role={"img"}
                    />
                  </Button>

                  <Button
                    className={classNames("__wab_instance", sty.button__t0Cd)}
                    icons={"only" as const}
                    link2={"http://pinterest.com" as const}
                  >
                    <Icon29Icon
                      className={classNames(defaultcss.all, sty.svg__iOfo)}
                      role={"img"}
                    />
                  </Button>
                </div>
              ...
              <Button
                children2={
                  <Icon15Icon
                    className={classNames(defaultcss.all, sty.svg__a352V)}
                    role={"img"}
                  />
                }
                className={classNames("__wab_instance", sty.button__ozaCt)}
                icons={"end" as const}
                slot={"English"}
              >
                <Icon15Icon
                  className={classNames(defaultcss.all, sty.svg___3Yjbq)}
                  role={"img"}
                />
              </Button>
            </React.Fragment>
