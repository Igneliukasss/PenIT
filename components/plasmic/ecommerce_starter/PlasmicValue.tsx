...
import * as sty from "./PlasmicValue.module.css"; // plasmic-import: Vb6XzVJUcph2/css

import Icon9Icon from "./icons/PlasmicIcon__Icon9"; // plasmic-import: a4crnjaPgZq1/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__k94Oe, {
          [sty.freeBox__center__k94OevMAtB]: hasVariant(
            variants,
            "center",
            "center"
          ),
          [sty.freeBox__topBottom__k94OeWjtnN]: hasVariant(
            variants,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(defaultcss.all, sty.freeBox___2Wj3T)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon9Icon
                className={classNames(defaultcss.all, sty.svg__ifB53)}
                role={"img"}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__qqy57, {
          [sty.freeBox__center__qqy57VMAtB]: hasVariant(
            variants,
            "center",
            "center"
          ),
          [sty.freeBox__withButton__qqy57Y1Ac]: hasVariant(
            variants,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant(variants, "withButton", "withButton") ? true : false) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__wuto6, {
            [sty.freeBox__center__wuto6VMAtB]: hasVariant(
              variants,
              "center",
              "center"
            ),
            [sty.freeBox__withButton__wuto6Y1Ac]: hasVariant(
              variants,
              "withButton",
              "withButton"
            )
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <Button
                children2={
                  <Icon5Icon
                    className={classNames(defaultcss.all, sty.svg___6Udg7)}
                    role={"img"}
                  />
                }
                className={classNames("__wab_instance", sty.button___2X8Do, {
                  [sty.button__withButton___2X8DoY1Ac]: hasVariant(
                    variants,
                    "withButton",
                    "withButton"
                  )
