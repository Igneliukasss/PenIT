...
import * as sty from "./PlasmicCartItem.module.css"; // plasmic-import: ujlAWg-ix6DC/css

import Icon31Icon from "./icons/PlasmicIcon__Icon31"; // plasmic-import: mtzUa2tFmbMr/icon
              ...
              defaultContents: (
                <React.Fragment>
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.freeBox__xuKMm)}
                  >
                    <Icon31Icon
                      className={classNames(defaultcss.all, sty.svg__amPat)}
                      role={"img"}
                    />

                    <Icon30Icon
                      className={classNames(defaultcss.all, sty.svg__aqLxt)}
                      role={"img"}
                    />
                  </p.Stack>
                </React.Fragment>
